/* $Id: VoltageReadStreamP.nc,v 1.1.2.1 2006-02-02 01:03:17 idgay Exp $
...
configuration VoltageReadStreamP {
...
implementation {
  components new ArbitratedReadStreamC(uniqueCount(UQ_VOLTAGEDEVICE_STREAM), uint16_t);
