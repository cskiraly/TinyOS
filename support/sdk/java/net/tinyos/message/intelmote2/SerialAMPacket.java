...
public class SerialAMPacket extends net.tinyos.message.Message {
    ...
    /**
     * Return the value (as a int) of the field 'header.addr'
     */
    public int get_header_addr() {
        return (int)getUIntBEElement(offsetBits_header_addr(), 16);
    }

    /**
     * Set the value of the field 'header.addr'
     */
    public void set_header_addr(int value) {
        setUIntBEElement(offsetBits_header_addr(), 16, value);
    }
