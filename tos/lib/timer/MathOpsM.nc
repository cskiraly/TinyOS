...
implementation
{
  ...
  async command int8_t MathI8.neg( int8_t a ) { return -a; }
  ...
  async command int16_t MathI16.neg( int16_t a ) { return -a; }
  ...
  async command int32_t MathI32.neg( int32_t a ) { return -a; }
  ...
  async command uint8_t MathU8.neg( uint8_t a ) { return -a; }
  ...
  async command uint16_t MathU16.neg( uint16_t a ) { return -a; }
  ...
  async command uint32_t MathU32.neg( uint32_t a ) { return -a; }
