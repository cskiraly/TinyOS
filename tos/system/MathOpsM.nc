...
implementation
{
  async command int8_t MathI8.cast_to( uint32_t a ) { return a; }
  async command uint32_t MathI8.cast_from( int8_t a ) { return a; }
  async command int8_t MathI8.inc( int8_t a ) { return ++a; }
  async command int8_t MathI8.dec( int8_t a ) { return --a; }
  ...
  async command int16_t MathI16.cast_to( uint32_t a ) { return a; }
  async command uint32_t MathI16.cast_from( int16_t a ) { return a; }
  async command int16_t MathI16.inc( int16_t a ) { return ++a; }
  async command int16_t MathI16.dec( int16_t a ) { return --a; }
  ...
  async command int32_t MathI32.cast_to( uint32_t a ) { return a; }
  async command uint32_t MathI32.cast_from( int32_t a ) { return a; }
  async command int32_t MathI32.inc( int32_t a ) { return ++a; }
  async command int32_t MathI32.dec( int32_t a ) { return --a; }
  ...
  async command uint8_t MathU8.cast_to( uint32_t a ) { return a; }
  async command uint32_t MathU8.cast_from( uint8_t a ) { return a; }
  async command uint8_t MathU8.inc( uint8_t a ) { return ++a; }
  async command uint8_t MathU8.dec( uint8_t a ) { return --a; }
  ...
  async command uint16_t MathU16.cast_to( uint32_t a ) { return a; }
  async command uint32_t MathU16.cast_from( uint16_t a ) { return a; }
  async command uint16_t MathU16.inc( uint16_t a ) { return ++a; }
  async command uint16_t MathU16.dec( uint16_t a ) { return --a; }
  ...
  async command uint32_t MathU32.cast_to( uint32_t a ) { return a; }
  async command uint32_t MathU32.cast_from( uint32_t a ) { return a; }
  async command uint32_t MathU32.inc( uint32_t a ) { return ++a; }
  async command uint32_t MathU32.dec( uint32_t a ) { return --a; }
